        ...
        <div className="relative z-10 flex min-h-[60vh] w-full items-center justify-center">
          <div className="flex flex-col items-center justify-center gap-6 px-8 md:px-16 lg:px-24 text-center max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-white/90 font-medium">
              Get a free quote for professional lawn care services. Fill out the form below and we&apos;ll get back to
              you soon.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-container px-4">
          <div className="max-w-4xl mx-auto mb-12">
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Whether you need weekly lawn maintenance, seasonal cleanup services, or specialized lawn care
                solutions, I&apos;m here to help. As a one-person operation, I provide personalized attention to every
                property, ensuring you receive reliable, professional service that exceeds expectations.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Simply fill out the form below with your contact information, property details, and the services
                you&apos;re interested in. I&apos;ll review your request and get back to you promptly with a customized
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-4">
                My services include professional lawn mowing with proper grass cutting techniques, precision lawn edging
                for clean borders, comprehensive weed control to eliminate and prevent weeds, thorough leaf raking and
                seasonal cleanup, and reliable snow shoveling during winter months. I use professional-grade equipment
                and proven techniques to ensure your lawn receives the best care possible.
              </p>
          ...
          <div className="max-w-4xl mx-auto mt-12">
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-4">
                Once you submit your quote request, I&apos;ll review all the details you&apos;ve provided about your
                property and lawn care needs. I typically respond within 24 hours to discuss your requirements and
                provide a customized estimate. During our conversation, I can answer any questions you have about my
                services, scheduling options, and pricing.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed mb-4">
                If you have photos of your property, feel free to include them with your request. This helps me provide
                a more accurate quote and better understand your specific lawn care needs. I&apos;ll work with you to
                create a service plan that fits your budget and schedule, whether you need weekly maintenance, bi-weekly
                service, or seasonal cleanups.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Ready to get started? Fill out the form above or contact me directly. I look forward to helping you
                achieve the beautiful, healthy lawn you deserve.
              </p>
            </div>
          </div>
        </div>

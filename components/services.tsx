      ...
      <div className="mx-auto max-w-container">
        <div className="flex flex-col items-center gap-4 text-center mb-12">
          ...
          <p className="text-md max-w-[800px] font-medium text-gray-400 sm:text-xl leading-relaxed">
            {SITE_NAME} offers professional lawn care and yard maintenance services for your home and business. From regular lawn mowing and precision edging to comprehensive weed control and seasonal cleanup, I ensure your outdoor spaces are both beautiful and well-maintained.
          </p>

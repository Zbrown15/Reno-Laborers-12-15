...
export function ServiceAreasHero() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      <Image
        src="/heroBG.jpg"
        alt="Lawn care service areas in Reno, Sparks, Spanish Springs, and Incline Village"
        fill
      ...
      <div className="relative z-10 flex min-h-screen w-full items-center justify-start">
        <div className="flex flex-col items-start justify-center gap-6 px-8 md:px-16 lg:px-24 text-left max-w-4xl">
          ...
          >
            Professional lawn care and yard maintenance services throughout Reno, Sparks, Spanish Springs, and Incline Village, Nevada.
          </motion.p>
        </div>
      </div>
    </div>
